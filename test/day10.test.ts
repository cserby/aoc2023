...
import { day10part1, findDistances, parseInput } from "../src/day10";
...
describe("Day10", () => {
  describe("Part1", () => {
    ...
    test("FindDistances", () => {
      expect(findDistances(parseInput(sample1))).toEqual([
      ...
      expect(findDistances(parseInput(sample2))).toEqual(
        [
